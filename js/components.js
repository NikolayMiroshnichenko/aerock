...
<div class="header-top container">
      ...
      <div class="header-top__right">
        <div class="header-number">
          ...
          <a href="#" class="header-number__item">+38 (000) 000-00-00</a>
          <a href="#" class="header-number__item">+38 (000) 000-00-00</a>
        </div>
        <div class="header-social">
          <a href="#" class="header-social__item facebook">facebook</a>
          <a href="#" class="header-social__item instagram">instagram</a>
          <a href="#" class="header-social__item youTube">YouTube</a>
        </div>
      </div>
    </div>
      ...
      <div class="header-catalog js-header-catalog">
        <div class="header-catalog__contain">
          <nav class="header-catalog__list">
            <a href="#" class="header-link">Стінові блоки AEROC</a>
            <a href="#" class="header-link">U-блоки AEROC</a>
            <a href="#" class="header-link">Теплоізоляція AEROC ENERGY</a>
            <a href="#" class="header-link">Армовані вироби AEROC</a>
            <a href="#" class="header-link">Сухі будівельні суміші AEROC</a>
            <a href="#" class="header-link">Інструмент AEROC</a>
            <a href="#" class="header-link">Інструкція користувача</a>
          </nav>
        </div>
      </div>
    </div>
`;
export const footerTemplate = ` <div class="footer-top container">
<div class="footer-top__item">
  ...
  <div class="footer-social">
    <a href="#" class="footer-social__item facebook">facebook</a>
    <a href="#" class="footer-social__item instagram">instagram</a>
    <a href="#" class="footer-social__item youTube">YouTube</a>
  </div>
</div>
<div class="footer-top__item">
